...
export const clippyPhrase = {
    inspiration: [
        ...
        { phrase: "The world always rewards those who are absolutely exceptional. ", animation: clippy3 },
        { phrase: "Everyone makes mistakes – it’s how we learn and grow.", animation: clippy1 },
        { phrase: "One day you will wake up and there won't be anymore time to do things you've always wanted. Do it now! ", animation: clippy7 },
        { phrase: "The only person who can miss a penalty is the one who dares to take it. ", animation: clippy2 },
        ...
        { phrase: "The only man who never makes mistakes is the man who never does anything. ", animation: clippy5 },
        ...
        { phrase: "One day, you'll leave this world behind, so live a life you will remember. ", animation: clippy3 },
        { phrase: "If people are not laughing at your goals, your goals are too small. ", animation: clippy4 },
        ...
        { phrase: "Some people die at 25 and aren't burried until they're 75. ", animation: clippy6 },
        { phrase: "I had a dream so big and loud, I jumped so high I touched the clouds. ", animation: clippy5 },
        { phrase: "The only limit is your imagination – let it soar!", animation: clippy2 },
        { phrase: "Keep moving forward, no matter the storms and the pouring rain. ", animation: clippy6 },
        { phrase: "If people are not laughing at your goals, your goals are too small. ", animation: clippy4 },
        { phrase: "Your words have power – use them wisely and with kindness.", animation: clippy7 },
        { phrase: "One day, you'll leave this world behind, so live a life you will remember. ", animation: clippy2 },
        { phrase: "The journey of a thousand miles begins with a single step. ", animation: clippy6 },
